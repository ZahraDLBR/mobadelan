...
class SimpleTest(unittest.TestCase):
    ...
    def test_register_exam(self):
            ...
            self.increase_wallet(20000)
            self.driver.find_element_by_id("paymentBtn").click()
            assert "payment" in self.driver.title
            self.driver.find_element_by_id("varizInBtn").click()
            self.driver.find_element_by_id("pay5hesabmaghsad").send_keys(self.user.bankAccount)
            self.driver.find_element_by_id("pay5varizi").send_keys(15000)
            self.driver.find_element_by_id("submitBtn").click()
            #commission
            assert "commission" in self.driver.title
            assert self.driver.find_element_by_id("commission").text is self.json["commission"]["varizIn"]*20000
    ...
    def test_bad(self):
        ...
        self.driver.find_element_by_id("varizInBtn").click()
        self.driver.find_element_by_id("pay5hesabmaghsad").send_keys(self.user.bankAccount)
        self.driver.find_element_by_id("pay5varizi").send_keys(150000)
        self.driver.find_element_by_id("submitBtn").click()
    ...
    def test_bad1(self):
        ...
        self.driver.find_element_by_id("varizInBtn").click()
        self.driver.find_element_by_id("pay5hesabmaghsad").send_keys(self.user.bankAccount)
        self.driver.find_element_by_id("pay5varizi").send_keys(100)
        self.driver.find_element_by_id("submitBtn").click()
